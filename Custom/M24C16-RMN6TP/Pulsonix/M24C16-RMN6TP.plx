...
//4318/1090090/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "M24C16-RMN6TP" (originalName "M24C16-RMN6TP")
	...
	(compDef "M24C16-RMN6TP" (originalName "M24C16-RMN6TP") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "__WC") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "M24C16-RMN6TP"))
		...
		(attr "Mouser Part Number" "511-M24C16-RMN6TP")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/M24C16-RMN6TP?qs=%252B9pWl1iD4MU2Vux9rOFCEg%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "M24C16-RMN6TP")
		(attr "Description" "M24C16-RMN6TP, Serial EEPROM Memory 16kbit, Serial-I2C, 900ns, 1.8V, 8-Pin SOIC")
		(attr "<Hyperlink>" "http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/DM00061111.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "M24C16-RMN6TP.stp")
