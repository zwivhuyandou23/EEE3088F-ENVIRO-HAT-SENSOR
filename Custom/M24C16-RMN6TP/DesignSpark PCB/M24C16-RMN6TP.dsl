...
(library Library_1
	...
	(compDef "M24C16-RMN6TP" (originalName "M24C16-RMN6TP") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "__WC") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/DM00061111.pdf")
		(attr "Height" "1.75 mm")
	)
